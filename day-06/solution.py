...
- Problem dataclass: Represents a parsed math problem
- evaluate_problem: Compute the result of a single problem
...
@dataclass
class Problem:
    """A parsed vertical math problem with operands, operation, and result."""
