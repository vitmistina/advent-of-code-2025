...
- `123` _ `45` _ `6` = `_33210_`
- `328` \+ `64` \+ `98` = `_490_`
- `51` _ `387` _ `215` = `_4243455_`
- `64` \+ `23` \+ `314` = `_401_`
...
- The second problem from the right is `175` _ `581` _ `32` = `_3253600_`
- The third problem from the right is `8` \+ `248` \+ `369` = `_625_`
- Finally, the leftmost problem is `356` _ `24` _ `1` = `_8544_`
